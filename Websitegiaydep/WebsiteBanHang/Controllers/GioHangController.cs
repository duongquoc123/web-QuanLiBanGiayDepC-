    ...
    public class GioHangController : Controller
    {
        ...
        public ActionResult GioHangPartial()
        {
            if (TinhTongSoLuong() == 0) //ktra soluong giỏ hàng
            {
                ...
                ViewBag.TongTien = 0;
                return PartialView();// Trả về Partial view để hiện tt giỏ hàng
            }
        ...
        public ActionResult ThemGioHang(int MaSP, string strURL)//Đây là một method  để thêm sản phẩm vào giỏ hàng.
                                                                //Nhận vào mã sản phẩm (MaSP) và URL của trang hiện tại (strURL).
        {
        ...
        //chỉnh sửa giỏ hàng
        [HttpGet]
        public ActionResult SuaGioHang(int MaSP)//để chỉnh sửa số lượng sản phẩm trong giỏ hàng.
        {
        ...
        //Cập nhật giỏ hàng
        [HttpPost]
        public ActionResult CapNhatGioHang(ItemGioHang itemGH)//gọi khi người dùng cập nhật số lượng sản phẩm trong giỏ hàng
        {
        ...
        //Xóa giỏ hàng
        public ActionResult XoaGioHang(int MaSP)//Xóa một sản phẩm khỏi giỏ hàng.
        {
            //ktra session giỏ hàng có tồn tại ko
            if (Session["GioHang"] == null)
            {
        ...
        //chức năng đặt hàng
        public ActionResult DatHang(KhachHang kh)//Đặt 1 sản phẩm từ giỏ hàng
        {
            //ktra session giỏ hàng có tồn tại ko
            if (Session["GioHang"] == null)
            {
